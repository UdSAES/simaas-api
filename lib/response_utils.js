...
const API_SPECIFICATION_FILE_PATH = './oas/simaas_oas3.json'
const API_SPECIFICATION_FILE_PATH_FLAT = './oas/simaas_oas3_flat.json'
...
async function serveOAS (req, res) {
  ...
  if (flatVersionWanted === true) {
    oas = await fs.readJson(API_SPECIFICATION_FILE_PATH_FLAT, {
      encoding: 'utf8'
    })
  } else {
